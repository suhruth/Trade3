...
- `watchlist.csv` — **the master input, hand-maintained.** Identity only: `symbol,sector,notes`; `symbol` must match the bhavcopy `SYMBOL`. Everything else (liquidity, returns, fundamentals, tier) is derived. Currently 50 names / 11 sectors.
